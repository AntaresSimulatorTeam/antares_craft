...
- The number of Monte-Carlo years prepared for the simulation is referred to as `nbyears` in the `generaldata.ini` file and as `nb_years` in the [`GeneralParameters`][antares.craft.model.settings.GeneralParameters] class.

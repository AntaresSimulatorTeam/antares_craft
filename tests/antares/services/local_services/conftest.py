...
from antares.craft import LinkProperties, LinkUi, ThematicTrimmingParameters, create_study_local
...
@pytest.fixture
def default_thematic_trimming_parameters_88() -> ThematicTrimmingParameters:

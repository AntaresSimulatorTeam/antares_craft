...
class TestWebClient:
    def test_lifecycle(
        ...
        # Case that succeeds
        load_matrix = pd.DataFrame(data=np.zeros((8760, 1), dtype=np.int64))
        ...
        ts_matrix = pd.DataFrame(data=np.ones((8760, 4), dtype=np.int64))
        ...
        prepro_modulation_matrix = pd.DataFrame(data=np.ones((8760, 6), dtype=np.int64))
        modulation_matrix = pd.DataFrame(data=np.ones((8760, 4), dtype=np.int64))
        series_matrix = pd.DataFrame(data=np.ones((8760, 6), dtype=np.int64))
        co2_cost_matrix = pd.DataFrame(data=np.ones((8760, 1), dtype=np.int64))
        fuel_cost_matrix = pd.DataFrame(data=np.ones((8760, 1), dtype=np.int64))
        ...
        injection_matrix = pd.DataFrame(data=np.zeros((8760, 1), dtype=np.int64))
        ...
        matrix = pd.DataFrame(data=(np.ones((8784, 1), dtype=np.int64)))
        ...
        new_matrix = pd.DataFrame(data=(np.ones((8784, 1), dtype=np.int64)))
        ...
        series_matrix = pd.DataFrame(data=np.zeros((8760, 3), dtype=np.int64))
        prepro_data_matrix = pd.DataFrame(data=np.ones((365, 6), dtype=np.int64))
        prepro_modulation_matrix = pd.DataFrame(data=np.ones((8760, 4), dtype=np.int64))
        ...
        default_credit_modulation = pd.DataFrame(np.ones((2, 101), dtype=np.int64))
        ...
        default_maxpower_matrix = np.zeros((365, 4), dtype=np.int64)
        ...
        default_inflow_pattern = pd.DataFrame(np.ones((365, 1), dtype=np.int64))
        assert area_fr.hydro.get_inflow_pattern().equals(default_inflow_pattern)

        default_ror = pd.DataFrame(np.zeros((8760, 1), dtype=np.int64))
        ...
        default_mod = pd.DataFrame(np.zeros((365, 1), dtype=np.int64))
        assert area_fr.hydro.get_mod_series().equals(default_mod)

        default_energy = pd.DataFrame(np.zeros((12, 5), dtype=np.int64))
        assert area_fr.hydro.get_energy().equals(default_energy)

        # tests the update for hydro matrices
        mod_series = pd.DataFrame(data=np.full((365, 1), 100, dtype=np.int64))
        ...
        max_power = np.full((365, 4), 1000, dtype=np.int64)
        max_power[:, 1] = 24
        max_power[:, 3] = 24
        maxpower_matrix = pd.DataFrame(data=max_power, dtype=np.int64)
        reservoir_matrix = pd.DataFrame(data=np.ones((365, 3), dtype=np.int64))
        inflow_pattern_matrix = pd.DataFrame(data=np.zeros((365, 1), dtype=np.int64))
        credits_matrix = pd.DataFrame(data=np.zeros((2, 101), dtype=np.int64))
        water_values_matrix = pd.DataFrame(data=np.ones((365, 101), dtype=np.int64))

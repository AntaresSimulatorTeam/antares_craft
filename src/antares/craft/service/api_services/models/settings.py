...
class ThematicTrimmingParametersAPI(APIBaseModel):
    ...
    def to_user_model(self) -> ThematicTrimmingParameters:
        return ThematicTrimmingParameters(
            ...
            solar=check_field_is_not_null(self.solar),
            nuclear=check_field_is_not_null(self.nuclear),
            lignite=check_field_is_not_null(self.lignite),
            coal=check_field_is_not_null(self.coal),
            gas=check_field_is_not_null(self.gas),
            oil=check_field_is_not_null(self.oil),
            mix_fuel=check_field_is_not_null(self.mix_fuel),
            misc_dtg=check_field_is_not_null(self.misc_dtg),
            ...
            misc_dtg_2=check_field_is_not_null(self.misc_dtg_2),
            misc_dtg_3=check_field_is_not_null(self.misc_dtg_3),
            misc_dtg_4=check_field_is_not_null(self.misc_dtg_4),
            wind_offshore=check_field_is_not_null(self.wind_offshore),
            wind_onshore=check_field_is_not_null(self.wind_onshore),
            solar_concrt=check_field_is_not_null(self.solar_concrt),
            solar_pv=check_field_is_not_null(self.solar_pv),
            solar_rooft=check_field_is_not_null(self.solar_rooft),
            renw_1=check_field_is_not_null(self.renw_1),
            renw_2=check_field_is_not_null(self.renw_2),
            renw_3=check_field_is_not_null(self.renw_3),
            renw_4=check_field_is_not_null(self.renw_4),

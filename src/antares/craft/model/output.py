...
class Output:
    ...
    See also the user documentation for more insights and explanations on
    [outputs](https://antares-doc.readthedocs.io/en/latest/reference/outputs/).
    """
    ...
    def aggregate_mc_ind_areas(
        ...
        Args:
            ...
            columns_names: List of the column names to fetch
                ...
                If not indicated, all outputs are aggregated.

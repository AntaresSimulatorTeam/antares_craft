...
class MCIndAreasDataType(Enum):
    """Types of data files generated by the simulation for each area, for each year.
...
class MCAllAreasDataType(Enum):
    """Types of data files generated by the simulation for each area,
...
class MCIndLinksDataType(Enum):
    """Types of data files generated by the simulation for each link, for each year.
